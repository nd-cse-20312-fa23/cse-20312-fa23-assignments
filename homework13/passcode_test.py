...
class PasscodeTests(unittest.TestCase):
    ...
    def test_00_doctest(self):
        failures, tests = doctest.testmod(passcode, verbose=False)
        self.assertEqual(failures, 0)
        self.assertEqual(tests, 4)
        PasscodeTests.Points += 0.5

    def test_01_mypy(self):
        _, _, exit_status = mypy.api.run(['passcode.py'])
    ...
    def test_03_compute_degrees(self):
        cases = (
    ...
    def test_04_find_passcode(self):
        cases = (
